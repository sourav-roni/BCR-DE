...
def self_save_file():
	train_x = np.load('../data/RR/train_seq.npy')
	val_x = np.load('../data/RR/val_seq.npy')
	test_x = np.load('../data/RR/test_seq.npy')
	train_y = np.load('../data/RR/train_pred.npy')
	val_y = np.load('../data/RR/val_pred.npy')
	test_y = np.load('../data/RR/test_pred.npy')

'''
This file is used from https://github.com/ChangWeiTan/TS-Extrinsic-Regression
to load the time series datasets mentioned in the paper https://arxiv.org/abs/2006.10996 
'''
